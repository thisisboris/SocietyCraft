package com.nijikokun.SC.register.payment;
...
public class Methods {
    ...
    private void _init() {
        this.addMethod("iConomy", new com.nijikokun.SC.register.payment.methods.iCo4());
        this.addMethod("iConomy", new com.nijikokun.SC.register.payment.methods.iCo5());
        this.addMethod("BOSEconomy", new com.nijikokun.SC.register.payment.methods.BOSE());
        this.addMethod("Essentials", new com.nijikokun.SC.register.payment.methods.EE17());
    }
